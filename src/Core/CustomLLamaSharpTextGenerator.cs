...
/// </summary>
public class CustomLlamaSharpTextGenerator : ITextGenerator, IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CustomLlamaSharpTextGenerator"/> class.
    /// </summary>
    /// <param name="config">The configuration for LLamaSharp.</param>
    public CustomLlamaSharpTextGenerator(LLamaSharpConfig config)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CustomLlamaSharpTextGenerator"/> class from reused weights, context and executor.
    ...
    public CustomLlamaSharpTextGenerator(LLamaWeights weights, LLamaContext context, StatelessExecutor? executor = null, InferenceParams? inferenceParams = null)
    {
        _weights = weights;
        _context = context;
